...
export async function health({repository,fetcher=fetch,now=Date.now()}={}){
 const result={app_ok:true,itick_ok:false,dxy_fresh:false,xau_quote_fresh:false,watcher_recent:false,latest_alert_time:null,jin10_ok:false,quote_fresh:false,redis_ok:false,state_storage_ok:false,latest_quote_time:null,latest_signal_time:null,current_state:null,deployment_version:process.env.VERCEL_GIT_COMMIT_SHA??'local-uncommitted',action:'NO_TRADE',reasons:[]};
 await Promise.all([
